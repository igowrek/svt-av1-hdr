...
| **NoiseChroma**                  | --noise-chroma         | [-1 - 100]     | -1          | Scale chroma noise based on luma or set a separate strength value, default is -1 [-1: on, 0: off, 1-100: strength value]                                              |
| **NoiseSize**                    | --noise-size           | [-1 - 15]      | -1          | Set size of noise grain, default is -1 [-1: auto, 0-15: set grain size]                                                                                               |
