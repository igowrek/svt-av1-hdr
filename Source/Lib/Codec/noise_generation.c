...
static const NoiseCoeffTable coeffs[] = {
    ...
    {3,
     7,
     {-1, -1, 3, 5, 3, 2, -4, -2, 8, -6, -17, -13, -1, 6, 2, -5, -9, 56, 21, -5, -2, 6, -21, 64},
     {-5, -4, -6, 8, -1, 1, -7, -7, -7, 7, -29, -11, 1, 0, -6, 13, -45, 55, -2, -16, -12, 17, -54, 71, -8},
     {-6, -9, -11, 16, -1, -1, -11, 7, 2, 13, -41, -1, -4, 6, -11, 11, -41, 62, -1, -13, -1, 16, -38, 69, -6}},
    {3,
     7,
     {-4, 1, 2, 5, 4, 2, 0, 1, 4, -4, -16, -14, 0, -1, 3, -4, -12, 55, 23, -5, 1, 4, -19, 68},
     {-9, -3, -11, 18, -2, -1, -6, -6, -3, 10, -44, -6, 1, -1, 1, -4, -45, 70, -5, -10, 0, 12, -34, 63, -2},
     {-1, 4, -11, 19, -6, 6, -18, 1, 0, 10, -43, -10, -11, 12, -10, 15, -44, 63, 2, -14, 2, 6, -35, 65, -3}},
};
...
static void set_scaling_points_y(AomFilmGrain *film_grain, const NoiseArgs *noise_args) {
    ...
    const double  noise         = (500.0 / large_side) * noise_setting;
...
static void set_scaling_points_uv(AomFilmGrain *film_grain, const NoiseArgs *noise_args) {
...
static uint8_t get_grain_size(const NoiseArgs *noise_args) {
    ...
    // where ~720p and lower gives 0, ~1080p gives 6, and ~2160p and above gives 15
    const int32_t grain_size = (19.4 * (1 - exp(-0.37 * (large_side / 640.0 - 2)))) + 0.5;
    return clamp(grain_size, 0, 15);
}
